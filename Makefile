.PHONY: help clean clean-build clean-pyc clean-test clean-venv flake8-check pylint-check test test35 test36 test37 test38 black-check black isort-check isort coverage dist dist-check
...
test: bootstrap ## run tests for all supported Python versions
	$(TOX) -e py37-test,py38-test -- $(TESTS)
